    ...
    <div class="login-page">
        <div class="form">
            ...
            <form action="{{ route('admin.foods.store') }}" method="POST" enctype="multipart/form-data">
                ...
                --}}
                <select class="form-control" name="food_types" id="">
                ...
                @enderror
                <input type="text" placeholder="Tên món tiếng việt" name="foodnamevn">
                @error('name')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <input type="text" placeholder="Tên món tiếng nhật" name="foodnamejp">
                @error('name')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
